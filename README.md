...
6. Keep chat scrolling behavior inside the commercial Chat Viewport infrastructure; see `Docs/commercial-chat-viewport-architecture.md` before changing message list, jump-to-latest, pagination or future social-chat behavior.
