...
- 会话界面的“当前会话 Workspace”控件支持选择多个目录、添加路径、设为主目录、移除 root；composer folder badge 额外提供“历史打开列表”二级菜单，点击历史项会加入当前 session roots 并设为 primary。
