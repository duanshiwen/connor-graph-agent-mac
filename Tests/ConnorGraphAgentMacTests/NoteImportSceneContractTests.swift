...
struct NoteImportSceneContractTests {
    ...
    func sharedImportModel() throws {
        ...
        #expect(compositionSource.components(separatedBy: "model.noteImportRuntimeFactory.makeModel()").count - 1 == 1)
        #expect(!compositionSource.contains("model.makeNoteImportViewModel()"))
