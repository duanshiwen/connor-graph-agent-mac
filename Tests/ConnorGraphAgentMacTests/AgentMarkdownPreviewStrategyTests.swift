...
struct AgentMarkdownPreviewStrategyTests {
    ...
    @Test func longMessageExpansionKeepsPreviewUntilTheFullDocumentLoads() throws {
        ...
        #expect(messageRows.contains("maxWidth: isNoteBody ? .infinity : AgentChatLayout.userMessageMaxWidth"))
        #expect(messageRows.contains("isNoteBody ? AgentChatLayout.messageBubbleHorizontalPadding : 0"))
