...
@Test func l4RelationPredicateDeclaresCompleteV1Vocabulary() {
    ...
    let expected: Set<String> = [
        ...
        "CREATED_BY", "MAINTAINED_BY", "OWNED_BY", "RESPONSIBLE_FOR", "CONTRIBUTED_BY", "REVIEWED_BY", "CURATED_BY", "AUTHORED_BY", "PUBLISHED_BY", "STAKEHOLDER_OF", "WORKS_ON",
        "ABOUT", "MENTIONS", "RELATED_TO", "ASSOCIATED_WITH"
    ]
