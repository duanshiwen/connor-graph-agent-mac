...
@Test func toolRegistryRegistersMemoryOSReadTools() throws {
    ...
    #expect(recentDefinition.description.contains("Leave query empty for a period-wide request"))
    ...
    #expect(recentQueryDescription.contains("use an empty string for a period-wide request"))
