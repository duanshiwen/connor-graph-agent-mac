...
@Test func toolRegistryRegistersMemoryOSReadTools() throws {
    ...
    #expect(profileDefinition.description.contains("preferences, habits, traits, constraints"))
    #expect(profileDefinition.description.contains("interaction guidance"))
    #expect(profileDefinition.description.contains("nextPage"))
    ...
    #expect(profileDefinition.description.contains("default compressed view"))
    #expect(profileDefinition.description.contains("view=raw"))
    #expect(profileDefinition.description.contains("if information is still missing afterward, continue calling any needed tools"))
