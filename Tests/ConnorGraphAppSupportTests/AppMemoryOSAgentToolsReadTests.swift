...
@Test func toolRegistryRegistersMemoryOSReadTools() throws {
    ...
    #expect(recentDefinition.description.contains("pageSize is runtime-controlled response metadata, not an input parameter"))
    ...
    #expect(knowledgeDefinition.description.contains("pageSize is runtime-controlled response metadata, not an input parameter"))
    ...
    #expect(profileDefinition.description.contains("pageSize is runtime-controlled response metadata, not an input parameter"))
    #expect(profileDefinition.description.contains("strongly prefer calling again with exactly nextPage"))
    #expect(profileDefinition.description.contains("You may stop early when the current task is already well supported"))
    #expect(profileDefinition.description.contains("A complete-profile or complete-coverage request must continue through nextPage: null"))
