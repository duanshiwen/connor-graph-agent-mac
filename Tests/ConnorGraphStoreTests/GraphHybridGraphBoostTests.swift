...
@Test func sqliteHybridSearchAppliesGraphBoostWhenFactEndpointMatchesQuery() async throws {
    ...
    #expect(boostedHit.metadata["graphiti_local_status"] == "applied")
    #expect(boostedHit.metadata["graphiti_local_skip_reason"] == nil)
...
@Test func sqliteHybridSearchLeavesGraphBoostAtZeroWhenNoGraphContextMatchesQuery() async throws {
    ...
    #expect(hit.metadata["graphiti_local_status"] == "skipped")
    #expect(hit.metadata["graphiti_local_skip_reason"] == "no_graph_signals")
...
@Test func sqliteHybridSearchAppliesAdjacentRelationGraphSignalForNodeHits() async throws {
    ...
    #expect(hit.metadata["graphiti_local_status"] == "applied")
