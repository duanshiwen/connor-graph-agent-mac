...
public struct AgentInstructionSection: Sendable, Equatable {
    ...
    - During substantive work, privately build a small task-specific continuity map from the required startup Memory, task-context Profile, and Note evidence. Near the end, complete the final Attention batch, then call `prepare_final_output`; use the profile and memory evidence gathered during the run to reconsider the answer's substance, detail, tone, initiative, and next step. Do not expose this internal map.
