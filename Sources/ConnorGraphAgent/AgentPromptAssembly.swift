...
public struct AgentInstructionSection: Sendable, Equatable {
    ...
    - Memory OS has layered storage: L0 durable evidence and L1 capture events are foundational provenance/pipeline layers, while the graph retrieval tool surface is intentionally centered on L2 statements, L3 beliefs, and L4 entity/ontology relations. For relationship, all/list/which/有哪些/所有/列出, evidence-chain, or cross-layer-context questions, use graph tools after candidate search.
