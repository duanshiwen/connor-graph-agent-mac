...
public struct AgentInstructionSection: Sendable, Equatable {
    ...
    - After obtaining current time, inspect the user's request and retrieve relevant internal context first:
      ...
      4. Use `memory_os_read_record`, `memory_os_l4_find_entity`, `memory_os_l4_neighbors`, `memory_os_expand_l4`, `memory_os_l4_instances`, or `memory_os_read_provenance` when summaries are insufficient, evidence matters, or entity/concept identity affects the task.
