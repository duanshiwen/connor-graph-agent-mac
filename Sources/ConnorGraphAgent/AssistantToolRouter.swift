...
public struct AssistantToolRouter: Sendable, Equatable {
    ...
    public static let namespaceDescriptors: [AssistantToolNamespaceDescriptor] = [
        ...
        .init(name: "base", summary: "Connor Base 小应用平台：结构化记忆小应用、多维表格、记账、预算、台账 / base apps, structured memory, tables, ledger", aliases: ["base", "小应用", "表格", "记账", "账本", "预算", "台账", "库存", "打卡", "结构化记忆", "多维表格", "子库", "记一笔", "app.create", "record.mutate"]),
