...
public struct AgentPromptModuleSpecification: Sendable, Equatable {
    ...
    public var title: String
    public var requirement: AgentPromptModuleRequirement
    public var loadingPolicy: AgentPromptModuleLoadingPolicy
    ...
    public init(
        ...
        title: String,
        requirement: AgentPromptModuleRequirement = .always,
        loadingPolicy: AgentPromptModuleLoadingPolicy = .eagerWhenRequired,
        summary: String = "",
...
public enum AgentPromptModuleLoadingPolicy: String, Codable, Sendable, Equatable {
    case kernel
    case eagerWhenRequired
    case onDemand
}
...
public enum AgentPromptModuleCatalog {
    ...
    public static let specifications: [AgentPromptModuleSpecification] = [
        .init(id: "identity", title: "Identity", loadingPolicy: .kernel),
        .init(id: "priority_order", title: "Priority Order", loadingPolicy: .kernel),
        .init(id: "cross_run_continuity", title: "Cross-Run Continuity"),
        .init(id: "personality_configuration", title: "Personality Configuration", loadingPolicy: .kernel),
        .init(id: "confidentiality", title: "Confidentiality and Non-Disclosure", loadingPolicy: .kernel),
        .init(id: "tool_usage_contract", title: "Tool Usage Contract", loadingPolicy: .kernel),
        ...
        .init(id: "workspace_tool_rules", title: "Workspace Tool Rules", requirement: .allOf([.workspace]), loadingPolicy: .onDemand, toolFamilies: ["workspace"]),
        ...
        .init(id: "workspace_execution_rules", title: "Workspace Execution Rules", requirement: .allOf([.workspace]), loadingPolicy: .onDemand, dependencies: ["workspace_tool_rules"], toolFamilies: ["workspace"]),
        .init(id: "tool_failure_safety", title: "Tool Failure and Safety Rules", loadingPolicy: .kernel),
        .init(id: "note_session_file_boundary", title: "Note Session File Boundary", requirement: .allOf([.workspace, .note])),
        .init(id: "programming_precision", title: "Programming and Precision Work", requirement: .allOf([.workspace]), loadingPolicy: .onDemand, dependencies: ["workspace_execution_rules"], toolFamilies: ["workspace"]),
        .init(id: "memory_architecture", title: "Memory OS Architecture", requirement: .allOf([.memory]), loadingPolicy: .kernel, toolFamilies: ["memory"]),
        .init(id: "note_reference_materials", title: "Note Reference Materials", requirement: .allOf([.note])),
        .init(id: "core_startup", title: "Core Startup and Final Preference Checkpoint", loadingPolicy: .kernel),
        .init(id: "current_time_retrieval", title: "Current Time Retrieval Rules", requirement: .allOf([.currentTime])),
        .init(id: "memory_retrieval", title: "Memory Retrieval Rules", requirement: .allOf([.memory]), loadingPolicy: .kernel, dependencies: ["memory_architecture"], toolFamilies: ["memory"]),
        .init(id: "calendar_retrieval", title: "Calendar Retrieval Rules", requirement: .allOf([.calendar]), loadingPolicy: .onDemand, toolFamilies: ["calendar"]),
        .init(id: "mail_retrieval", title: "Mail Retrieval Rules", requirement: .allOf([.mail]), loadingPolicy: .onDemand, toolFamilies: ["mail"]),
        .init(id: "skill_discovery", title: "Skill Discovery Rules", requirement: .allOf([.skills]), loadingPolicy: .onDemand, toolFamilies: ["skills"]),
        .init(id: "note_retrieval", title: "Note Retrieval Rules", requirement: .allOf([.note]), loadingPolicy: .onDemand, toolFamilies: ["note"]),
        .init(id: "cloud_knowledge_retrieval", title: "Cloud Knowledge Retrieval Rules", requirement: .allOf([.cloudKnowledge]), loadingPolicy: .onDemand, toolFamilies: ["external-research"]),
        .init(id: "web_research", title: "Web Research Rules", requirement: .allOf([.web]), loadingPolicy: .kernel, toolFamilies: ["external-research"]),
        .init(id: "retrieval_completion", title: "Retrieval Completion Rules", loadingPolicy: .kernel),
        .init(id: "skill_instruction_authority", title: "Skill Instruction Authority", loadingPolicy: .kernel),
        .init(id: "connor_skill_tools", title: "Connor Skill Tools", requirement: .allOf([.skills])),
        .init(id: "evidence_finalization", title: "Evidence, Tool Output, and Finalization", loadingPolicy: .kernel),
        ...
        .init(id: "mail_tool_workflow", title: "Mail Tool Workflow", requirement: .allOf([.mail]), loadingPolicy: .onDemand, dependencies: ["mail_retrieval"], toolFamilies: ["mail"]),
        .init(id: "calendar_tool_workflow", title: "Calendar Tool Workflow", requirement: .allOf([.calendar]), loadingPolicy: .onDemand, dependencies: ["calendar_retrieval"], toolFamilies: ["calendar"]),
        .init(id: "rss_tool_workflow", title: "RSS Tool Workflow", requirement: .allOf([.rss]), loadingPolicy: .onDemand, toolFamilies: ["rss"]),
        .init(id: "browser_history_workflow", title: "Browser History Tool Workflow", requirement: .allOf([.browserHistory]), loadingPolicy: .onDemand, toolFamilies: ["browser-history"]),
        ...
        .init(id: "stop_conditions", title: "Stop Conditions", loadingPolicy: .kernel),
        .init(id: "response_style", title: "Response Style", loadingPolicy: .kernel),
    ...
    public static func activatedModuleIDs(
        requested: [AgentPromptModuleID],
        capabilities: Set<AgentPromptCapability>
    ) -> [AgentPromptModuleID] {
        let byID = specificationByID
        let roots = specifications.filter {
            $0.loadingPolicy == .kernel || ($0.loadingPolicy == .eagerWhenRequired && $0.requirement.isSatisfied(by: capabilities))
        }.map(\.id) + requested
        var visited = Set<AgentPromptModuleID>()
        var ordered: [AgentPromptModuleID] = []
        func activate(_ id: AgentPromptModuleID) {
            guard !visited.contains(id), let specification = byID[id] else { return }
            guard specification.loadingPolicy == .kernel || specification.requirement.isSatisfied(by: capabilities) else { return }
            specification.dependencies.sorted { $0.rawValue < $1.rawValue }.forEach(activate)
            guard visited.insert(id).inserted else { return }
            ordered.append(id)
        }
        roots.forEach(activate)
        let catalogOrder = Dictionary(uniqueKeysWithValues: specifications.enumerated().map { ($0.element.id, $0.offset) })
