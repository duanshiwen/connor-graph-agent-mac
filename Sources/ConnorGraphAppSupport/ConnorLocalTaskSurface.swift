...
public enum ConnorLocalTaskSurfaceCatalog {
    ...
    public static let defaultCommands: [ConnorTaskCLICommandPresentation] = [
        ...
        .init(id: .taskPurge, name: "tasks purge", usage: "connor tasks purge <task-id>", summary: "Permanently remove a task (including protected system tasks).", riskLevel: .stateChanging, examples: ["connor tasks purge system.memory-os.plan-l2-to-knowledge"]),
        .init(id: .taskRename, name: "tasks rename", usage: "connor tasks rename <task-id> <new-name>", summary: "Rename a task.", riskLevel: .stateChanging, examples: ["connor tasks rename system.memory-os.plan-l1-to-l2 \"Memory OS: L1 Event Processing\""], apiRoute: .taskRuns),
