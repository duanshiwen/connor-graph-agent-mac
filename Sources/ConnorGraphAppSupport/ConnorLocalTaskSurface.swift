...
public enum ConnorLocalTaskSurfaceCatalog {
    ...
    public static let defaultCommands: [ConnorTaskCLICommandPresentation] = [
        ...
        .init(id: .taskPurge, name: "tasks purge", usage: "connor tasks purge <task-id>", summary: "Permanently remove a task (including protected system tasks).", riskLevel: .stateChanging, examples: ["connor tasks purge system.memory-os.plan-l1-to-l2"]),
