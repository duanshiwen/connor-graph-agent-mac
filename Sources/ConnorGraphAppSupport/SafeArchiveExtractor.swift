...
public enum SafeArchiveError: Error, Sendable, Equatable { case unsafePath(String); case symbolicLink(String); case entryLimit; case entryTooLarge(String); case totalSizeLimit; case compressionBomb(String); case depthLimit(String); case extractionEscapedRoot(String); case unsupportedArchive(String); case extractionFailed(String) }
