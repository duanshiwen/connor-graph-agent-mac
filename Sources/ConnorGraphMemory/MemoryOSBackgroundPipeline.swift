...
public enum MemoryOSBackgroundToolCatalog {
    ...
    public static func promptSection(for tools: [MemoryOSBackgroundToolDescriptor], stage: String) -> String {
        ...
        - Pass `page` and `depth` as JSON integers, never quoted strings. When `nextPage` is non-null, call the same context tool again with `page` set to that exact integer and all other search arguments unchanged.
