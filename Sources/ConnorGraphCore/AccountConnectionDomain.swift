...
public struct ConnectedAccountCredentialBinding: Codable, Sendable, Equatable, Hashable {
    ...
    public init(credentialNamespace: String, accountName: String, authMode: ConnectedAccountAuthMode) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        authMode = try container.decode(ConnectedAccountAuthMode.self, forKey: .authMode)
    }
