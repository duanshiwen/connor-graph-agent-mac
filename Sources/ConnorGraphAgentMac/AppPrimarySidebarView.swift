        ...
        VStack(spacing: 10) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    SidebarRow(title: "人际关系", systemImage: "person.crop.circle.badge", count: viewModel.contactsBrowserPresentation.rows.count, isSelected: selection == .contacts) { select(.contacts) }
